...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n----Sign In Gmail------");
		SignInManager signInManagerGmail= new SignInManager(new PostaAdapter());
		signInManagerGmail.signInAdapter(new SignInCustomer("omeralpergunes@gmail.com","66265"));
		signInManagerGmail.signInAdapter(new SignInCustomer("enginhoca@gmail.com","5623"));
	}
